...
type SearchLaptopRequest struct {
	...
	Laptop *Filter `protobuf:"bytes,1,opt,name=laptop,proto3" json:"laptop,omitempty"`
}
...
func (x *SearchLaptopRequest) GetLaptop() *Filter {
	if x != nil {
		return x.Laptop
	}
	return nil
...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x06, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x22, 0x3d, 0x0a,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_laptop_service_proto_depIdxs = []int32{
	...
	10, // 1: proto.SearchLaptopRequest.laptop:type_name -> proto.Filter
